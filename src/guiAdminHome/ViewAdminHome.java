...
public class ViewAdminHome {
	...
	*/
	...
	protected static String [] roles = {"Admin", "Role1", "Role2", "None"};
	protected static Button button_SendInvitation = new Button("Send Invitation");
	protected static Alert alertNewUserNotAssignedRole = new Alert(AlertType.INFORMATION);
	...
	*/
	...
	private ViewAdminHome() {
		...
		alertNewUserNotAssignedRole.setTitle("No Role Assigned");
		alertNewUserNotAssignedRole.setHeaderText("A role must be assigned to any new users.");
		alertNewUserNotAssignedRole.setContentText("Select a role and try again.");
		alertEmailSent.setTitle("Invitation");
		alertEmailSent.setHeaderText("Invitation was sent");
		alertEmailSent.getDialogPane().setMinHeight(Region.USE_PREF_SIZE);
		...
		// GUI Area 4
		setupButtonUI(button_ManageInvitations, "Dialog", 16, 250, Pos.CENTER, 20, 295);
		button_ManageInvitations.setOnAction((_) -> 
			{ControllerAdminHome.manageInvitations(); });

		setupButtonUI(button_DeleteUser, "Dialog", 16, 250, Pos.CENTER, 20, 345);
