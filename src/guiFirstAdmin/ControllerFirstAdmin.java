...
public class ControllerFirstAdmin {
	...
	*/
	...
	protected static void doSetupAdmin(Stage ps, int r) {
		...
		String usernameError = ControllerNewAccount.checkForValidUserName(adminUsername);
		if (usernameError.isEmpty()) {
			...
			if (adminPassword1.compareTo(adminPassword2) == 0) {
	        	...
	        	String passwordErrorMessage = Model.evaluatePassword(adminPassword1);
	        	if (!passwordErrorMessage.isEmpty()) {
	        	    ...
	        	    alertPasswordInvalid.setContentText(passwordErrorMessage);
