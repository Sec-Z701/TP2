...
public class View {
	...
	static protected Label label_MaxLength = new Label();
	...
	public static void view (Pane theRoot) {
	    ...
	    setupLabelWidget(label_MaxLength, 30, 330, "Arial", 14, windowWidth-10, 
	    		Pos.BASELINE_LEFT);
		...
		theRoot.getChildren().addAll(label_Password, text_Password, noInputFound, 
				...
				label_SpecialChar, label_LongEnough, label_MaxLength, button_Finish);
	}
	...
	static protected void resetAssessments() {
	    ...
	    label_MaxLength.setText("Does not exceed 28 characters - Not yet satisfied");
	    label_MaxLength.setTextFill(Color.RED);
	}
