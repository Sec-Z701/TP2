...
public class Model {
	...
	private static void updateFlags() {
		...
		if (!foundTooLong) {
		    View.label_MaxLength.setText("Does not exceed 28 characters - Satisfied");
		    View.label_MaxLength.setTextFill(Color.GREEN);
		}
	}
	...
	public static String evaluatePassword(String input) {
		...
		if (input.length() > 28) {
		    foundTooLong = true;
		    passwordIndexofError = 28;
		    return "*** Error *** Password exceeds maximum length of 28 characters!";
		}
		...
		while (running) {
			...
			if (currentCharNdx >= 28) {
			    System.out.println("Password exceeds maximum length");
			    foundTooLong = true;
