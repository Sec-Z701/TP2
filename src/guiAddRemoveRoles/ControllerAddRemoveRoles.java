...
public class ControllerAddRemoveRoles {
	...
	private static void setupSelectedUser() {
		...
		if (theDatabase.getCurrentAdminRole() && !(ViewAddRemoveRoles.theSelectedUser.equals(ViewAddRemoveRoles.theUser.getUserName()))) // Don't let the admin delete their own admin role
